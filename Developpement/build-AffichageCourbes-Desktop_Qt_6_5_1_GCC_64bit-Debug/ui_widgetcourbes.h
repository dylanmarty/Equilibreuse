...
public:
    ...
    QLineEdit *LineEditDecalageOrigine;
    ...
    void setupUi(QWidget *WidgetCourbes)
    {
        ...
        layoutWidget = new QWidget(WidgetCourbes);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(30, 460, 731, 34));
        horizontalLayout = new QHBoxLayout(layoutWidget);
        horizontalLayout->setObjectName("horizontalLayout");
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        LineEditDecalageOrigine = new QLineEdit(layoutWidget);
        LineEditDecalageOrigine->setObjectName("LineEditDecalageOrigine");

        horizontalLayout->addWidget(LineEditDecalageOrigine);
